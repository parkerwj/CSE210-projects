...
class Program
{
    ...
    {   
        ...
        //order 1 
        Address address1 = new Address ("2316 Roanoke Springs Dr", "Ruskin", "FL", "USA");
        Customer customer1 = new Customer("James Montgomery", address1);
        ...
        //order 2
        Address address2 = new Address ("Rua João José Martins", "São José", "Santa Catarina", "Brasil");
        Customer customer2 = new Customer("João Garcia", address2);
